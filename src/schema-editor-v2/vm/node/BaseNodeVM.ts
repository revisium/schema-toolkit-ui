...
export abstract class BaseNodeVM {
  ...
  public get isString(): boolean {
    return this._node.nodeType() === 'string';
  }

  public get isNumber(): boolean {
    return this._node.nodeType() === 'number';
  }

  public get isBoolean(): boolean {
    return this._node.nodeType() === 'boolean';
  }
  ...
  public get validationError(): string | null {
    ...
    const errors = this._editor.schemaModel.validationErrors;
  ...
  public get canDrag(): boolean {
    ...
    return this._editor.schemaModel.hasValidDropTarget(this.nodeId);
  }
  ...
  public rename(newName: string): void {
    if (newName !== this.name) {
      if (this._isRoot) {
        ...
        this._editor.schemaModel.renameField(this.nodeId, newName);
      }
    }
  }

  public setDescription(value: string): void {
    this._editor.schemaModel.updateMetadata(this.nodeId, {
  ...
  public canAcceptDrop(fromNodeId: string): boolean {
    return this._editor.schemaModel.canMoveNode(fromNodeId, this.nodeId);
  }
