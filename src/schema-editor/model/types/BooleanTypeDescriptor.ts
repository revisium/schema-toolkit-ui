...
import type { JsonBooleanSchema, JsonSchemaType } from '../schema/JsonSchema';
...
export const booleanTypeDescriptor: TypeDescriptor<
  JsonBooleanSchema,
  BooleanNode
> = {
  type: 'boolean',
  ...
  serialize(node: BooleanNode, _context: SerializeContext): JsonBooleanSchema {
