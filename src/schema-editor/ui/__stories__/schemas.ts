// NOTE: These schemas use string literals for type field for readability.
// They are cast to JsonObjectSchema at runtime.
...
export const arrayOfStringsSchema = {
  type: 'array',
  items: { type: 'string', default: '' },
  default: [],
};

export const arrayOfNumbersSchema = {
  type: 'array',
...
export const arrayOfArraysSchema = {
  type: 'array',
  items: {
    type: 'array',
    items: { type: 'string', default: '' },
...
export const primitiveStringSchema = {
  type: 'string',
  default: '',
};

export const primitiveNumberSchema = {
  type: 'number',
  default: 0,
};

export const primitiveBooleanSchema = {
  type: 'boolean',
  default: false,
};
...
export const arrayFieldsSchema = {
  type: 'object',
  properties: {
    tags: {
      type: 'array',
...
export const foreignKeysSchema = {
  type: 'object',
  properties: {
    title: { type: 'string', default: '' },
...
export const simpleFormulaSchema = {
  type: 'object',
  properties: {
    price: { type: 'number', default: 0 },
    quantity: { type: 'number', default: 1 },
...
export const formulaChainSchema = {
  type: 'object',
  properties: {
    price: { type: 'number', default: 0 },
    quantity: { type: 'number', default: 1 },
...
export const formulaInNestedSchema = {
  type: 'object',
  properties: {
    order: {
      type: 'object',
...
export const formulaInArraySchema = {
  type: 'object',
  properties: {
    items: {
      type: 'array',
...
export const formulaWithErrorSchema = {
  type: 'object',
  properties: {
    value: { type: 'number', default: 0 },
    computed: {
...
export const mixedComplexSchema = {
  type: 'object',
  properties: {
    name: { type: 'string', default: '' },
    categoryId: { type: 'string', default: '', foreignKey: 'categories' },
...
export const longFieldNamesSchema = {
  type: 'object',
  properties: {
...
export const unicodeFieldsSchema = {
  type: 'object',
  properties: {
